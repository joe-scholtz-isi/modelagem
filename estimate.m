...
dtime = linspace(0,data(length(data),1)-data(1,1),length(data))';
%tt = timetable(dtime,data(:,2),data(:,3));

[sys2, ic2 ] = tfestimate(tt,2)
[sys3, ic3 ] = tfestimate(tt,3)
[sys4, ic4 ] = tfestimate(tt,4)
[sys5, ic5 ] = tfestimate(tt,5)
